  ...
  <div id="faq" class="container mx-auto px-5 md:w-4/5">
    <section class="py-16 pt-18">
      <div class="w-4/5 md:w-3/5 mx-auto">
        <h2 class="text-3xl md:text-4xl font-theme-heading font-medium text-center">Dúvidas Comuns</h2>
        <!-- <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">
          Here are some of out FAQs. If you have any other quesitons you'd like answered please feel free to email us.
        </p> -->
      </div>
      ...
      <div class="mt-10 w-full lg:w-3/5 mx-auto">
        <ul class="shadow-lg">
          <template v-for="(faq, index) in faqs" :key="faq.id">
            ...
            >
              <h6 class="flex-1">{{ faq.title }}</h6>
              <svg
                :class="isOpen === faq.id ? 'rotate-180 text-theme-secondary' : 'rotate-0 text-theme-primary'"
                class="transform"
