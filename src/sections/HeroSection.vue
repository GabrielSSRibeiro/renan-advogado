  ...
  <div id="hero" class="container mx-auto px-5 overflow-x-hidden lg:overflow-x-visible">
    <section class="grid grid-cols-none lg:grid-cols-2 pb-16 items-center">
      <div class="lg:w-5/6 order-2 lg:order-none">
        <h1 class="xl:text-3xl font-bold font-theme-heading text-center lg:text-left">Dr. Renan Soares Ferreira Araujo OAB/RJ 223502</h1>
    ...
    <section class="grid grid-cols-none lg:grid-cols-2 mt-16 pb-16 items-center">
      <div class="lg:w-5/6 order-2 lg:order-none">
        ...
        <p class="lg:text-xl mt-10 font-theme-content text-center lg:text-left">
          Advogada especializada e com atuação na defesa do consumidor a mais de X anos.
        </p>
