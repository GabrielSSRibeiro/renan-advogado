...
<template>
  ...
  <div class="container mx-auto px-5">
    <header class="flex justify-between items-center">
      <div class="">
        <img class="z-10 w-1/2 opacity-0" src="/images/logo-horizontal.png" alt="Soares logo" />
      </div>
    ...
    <div v-show="mobileNav">
      ...
      >
        <div class="flex justify-between items-center">
          <a class="uppercase text-white hover:text-theme-primary transition duration-200" href="/">Frones & Soares</a>
